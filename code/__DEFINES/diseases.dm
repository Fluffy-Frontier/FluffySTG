...
#define DISEASE_SLOWDOWN_RECOVERY_BONUS 1 // FLUFFY FRONTIER EDIT - ORIGINAL: #define DISEASE_SLOWDOWN_RECOVERY_BONUS 3
...
#define DISEASE_SLOWDOWN_RECOVERY_BONUS_DURATION 100 // FLUFFY FRONTIER EDIT - ORIGINAL: #define DISEASE_SLOWDOWN_RECOVERY_BONUS_DURATION 200
/// Negative Malnutrition Recovery Penalty
//// Flat penalty to recovery chance if malnourished or starving
#define DISEASE_MALNUTRITION_RECOVERY_PENALTY 1.5 // FLUFFY FRONTIER EDIT - ORIGINAL: #define DISEASE_MALNUTRITION_RECOVERY_PENALTY 3
...
#define DISEASE_SATIETY_RECOVERY_MULTIPLIER 1 // FLUFFY FRONTIER EDIT - ORIGINAL: #define DISEASE_SATIETY_RECOVERY_MULTIPLIER 3
...
#define DISEASE_GOOD_SLEEPING_RECOVERY_BONUS 0.2 // FLUFFY FRONTIER EDIT - ORIGINAL: #define DISEASE_GOOD_SLEEPING_RECOVERY_BONUS 0.6
...
#define DISEASE_SLEEPING_RECOVERY_MULTIPLIER 2 // FLUFFY FRONTIER EDIT - ORIGINAL: #define DISEASE_SLEEPING_RECOVERY_MULTIPLIER 6
...
#define DISEASE_FINAL_CURE_CHANCE_MULTIPLIER 6 // FLUFFY FRONTIER EDIT - ORIGINAL: #define DISEASE_FINAL_CURE_CHANCE_MULTIPLIER 3
...
#define DISEASE_SYMPTOM_OFFSET_DURATION 100 // FLUFFY FRONTIER EDIT - ORIGINAL: #define DISEASE_SYMPTOM_OFFSET_DURATION 100
