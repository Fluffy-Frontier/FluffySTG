...
#define HEAVY_PISTOL_SLOWDOWN 0.15
#define SMG_SLOWDOWN 0.2
#define LIGHT_RIFLE_SLOWDOWN 0.25
#define RIFLE_SLOWDOWN 0.3
#define SHOTGUN_SLOWDOWN 0.35
#define DMR_SLOWDOWN 0.4
#define HMG_SLOWDOWN 0.45
