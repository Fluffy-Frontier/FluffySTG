...
GLOBAL_LIST_INIT(paper_blanks, init_paper_blanks()) // FLUFFY FRONTIER CHANGE - REVERT TO TG // NOVA EDIT CHANGE - ORIGINAL: GLOBAL_LIST_INIT(paper_blanks, init_paper_blanks())
