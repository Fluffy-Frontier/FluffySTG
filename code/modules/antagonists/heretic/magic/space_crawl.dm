...
/datum/action/cooldown/spell/jaunt/space_crawl
	...
	var/static/list/jaunting_traits = list(TRAIT_RESISTLOWPRESSURE, TRAIT_RESISTCOLD, TRAIT_NOBREATH) //FLUFFY FRONTIER CHANGE - Nerf revert // NOVA EDIT CHANGE - ORIGINAL var/static/list/jaunting_traits = list(TRAIT_RESISTLOWPRESSURE, TRAIT_RESISTCOLD, TRAIT_NOBREATH)
