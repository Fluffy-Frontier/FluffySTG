...
/datum/unit_test/barsigns_icon
	var/list/blacklisted_sign_types = list(/datum/barsign/fluffy, /datum/barsign/nova, /datum/barsign/nova/large) // NOVA EDIT ADDITION - Modular barsigns // THE FLUFFY FRONTIER EDIT ADDITION - Modular barsigns
