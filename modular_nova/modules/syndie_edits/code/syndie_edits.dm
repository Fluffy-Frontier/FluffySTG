...
/obj/item/clothing/head/bio_hood/interdyne
	...
	icon = 'modular_nova/master_files/icons/obj/clothing/hats.dmi'
	worn_icon = 'modular_nova/master_files/icons/mob/clothing/head.dmi'
	worn_icon_teshari = 'tff_modular/modules/clothing/icons/mob/species/head_teshar.dmi' //FLUFFY FRONTIER ADD
...
/obj/item/clothing/suit/bio_suit/interdyne
	...
	slowdown = 0.3
	supports_variations_flags = CLOTHING_DIGITIGRADE_VARIATION_NO_NEW_ICON
	worn_icon_teshari = 'tff_modular/modules/clothing/icons/mob/species/suit_teshar.dmi' //FLUFFY FRONTIER ADD
