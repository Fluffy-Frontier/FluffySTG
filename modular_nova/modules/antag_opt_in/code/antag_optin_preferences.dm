...
/datum/preference/choiced/antag_opt_in_status/init_possible_values()
	return list(OPT_IN_YES_KILL, OPT_IN_YES_ROUND_REMOVE) // FLUFFY FRONTIER EDIT - ORIGINAL: list(OPT_IN_YES_TEMP, OPT_IN_YES_KILL, OPT_IN_YES_ROUND_REMOVE, OPT_IN_NOT_TARGET)
