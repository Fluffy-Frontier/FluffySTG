/datum/supply_pack/science/synthetic_burns
	...
	cost = CARGO_CRATE_VALUE * 3.75 // FLUFFY FRONTIER EDIT. ORIGINAL: CARGO_CRATE_VALUE * 2.5
	...
	access_view = ACCESS_SCIENCE // FLUFFY FRONTIER EDIT. ORIGINAL: FALSE
	access = FALSE
	access_any = FALSE
...
/datum/supply_pack/science/synth_healing_chems
	...
	cost = CARGO_CRATE_VALUE * 10.5 // rarely made, so it should be expensive(?) // FLUFFY FRONTIER EDIT. ORIGINAL: CARGO_CRATE_VALUE * 7
	contains = list(
...
/datum/supply_pack/science/synth_medkits
	...
	cost = CARGO_CRATE_VALUE * 6.75 // same as treatment kits // FLUFFY FRONTIER EDIT. ORIGINAL: CARGO_CRATE_VALUE * 4.5
