...
// Того самого автомаппера, который добаляет на ТГшные карты шкафы БЩ, вендор командный и прочее.
// Вписывать название карты, которое в map_name в конфиге самой карты.
#define FF_BLACKLISTED_STATIONS list("NSS Journey", "Kilo Station", "Border Station")
