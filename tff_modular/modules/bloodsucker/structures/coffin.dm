...
/obj/structure/closet/crate/coffin/can_open(mob/living/user)
	...
	if(user == resident)
		...
		locked = FALSE
		return TRUE
	playsound(get_turf(src), 'tff_modular/modules/bloodsucker/bloodsucker_sound/coffin_locked.ogg', 20, 1)
...
/obj/structure/closet/crate/proc/enlarge(mob/living/user)
	...
	playsound(src, 'tff_modular/modules/bloodsucker/bloodsucker_sound/creaking.ogg')
