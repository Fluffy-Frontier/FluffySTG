...
/atom/movable/screen/ammo_counter_shiptest
	name = "ammo counter"
	icon = 'tff_modular/modules/modular_weaponry/icons/gun_hud.dmi'
	icon_state = "backing"
...
/datum/component/ammo_hud_shiptest/proc/turn_on()
	...
	RegisterSignal(parent, COMSIG_GUN_CHAMBER_PROCESSED, PROC_REF(update_hud))
...
/datum/component/ammo_hud_shiptest/revolver/update_hud()
	...
	for(var/obj/item/ammo_casing/bullet as anything in rounds)
		...
		if(!bullet)
			continue
		var/image/current_bullet_image = image(icon = 'tff_modular/modules/modular_weaponry/icons/gun_hud.dmi')
