...
/obj/item/attachment
	...
	desc = "alert coders"
	icon = 'tff_modular/modules/modular_weaponry/icons/attachments.dmi'
...
/obj/item/attachment/proc/apply_attachment(obj/item/gun/gun, mob/user)
	...
	if(istype(gun, /obj/item/gun/energy))
		var/obj/item/gun/energy/laser = gun
		gun_cell = laser.cell
	playsound(src.loc, 'sound/items/weapons/gun/pistol/mag_insert.ogg', 75, 1)
	return TRUE
...
/obj/item/attachment/proc/remove_attachment(obj/item/gun/gun, mob/user)
	...
	playsound(src.loc, 'sound/items/weapons/gun/pistol/mag_release.ogg', 75, 1)
	gun_cell = null
	return TRUE
