/datum/techweb_node/mod_security
	...
	prereq_ids = list(TECHWEB_NODE_MOD_SECURITY, TECHWEB_NODE_AUS_SECURITY, TECHWEB_NODE_MOD_EXPERIMENTAL)
	design_ids = list(
		"mod_energy_spear",
		"mod_brace_shield",
		"mod_energy_canon",
...
/datum/techweb_node/mod_engi_stasis
	...
	prereq_ids = list(TECHWEB_NODE_MOD_EXPERIMENTAL, TECHWEB_NODE_MOD_ENGI_ADV)
...
/datum/techweb_node/mod_general_advanced
	...
	prereq_ids = list(TECHWEB_NODE_MOD_EXPERIMENTAL)
	design_ids = list(
		"mod_sprinter",
		"mod_enr_eff",
		"mod_speed_eff",
...
/datum/techweb_node/mod_suits_research
	...
	display_name = "Research modsuits"
	prereq_ids = list(TECHWEB_NODE_MOD_EXPERIMENTAL)
	design_ids = list(
