/obj/machinery/vending/clothing
	contraband_ff = list(
		/obj/item/clothing/neck/playbunny = 3,
		...
		/obj/item/clothing/suit/jacket/playbunny = 3,
		/obj/item/clothing/suit/jacket/playbunny/brit = 3,
		/obj/item/clothing/suit/jacket/playbunny/plasma = 3,
		/obj/item/clothing/suit/jacket/playbunny/communist = 3,
		/obj/item/clothing/suit/jacket/playbunny/stars = 3,
		/obj/item/clothing/neck/playbunny = 3,
		/obj/item/clothing/neck/playbunny/communist = 3,
		/obj/item/clothing/neck/playbunny/blue = 3,
		/obj/item/clothing/head/playbunny = 3,
		/obj/item/clothing/head/playbunny/british = 3,
		/obj/item/clothing/head/playbunny/communist = 3,
		/obj/item/clothing/head/playbunny/usa = 3,
