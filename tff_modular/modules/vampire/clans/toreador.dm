/datum/vampire_clan/toreador
	...
	description = "The Toreador are a clan of vampires known for being some of the most beautiful, sensual, seductive, emotional and glamorous of the Kindred.<br><br>\
		...
		They are inherently divas by blood, and their humanity and sense of morality may plummit as fast as it rises. Due to their grace and gentleness of action, Toreadors do not leave bite marks on the victim's body."
