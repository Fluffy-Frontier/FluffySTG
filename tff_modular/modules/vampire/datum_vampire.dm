/datum/antagonist/vampire
	...
	hijack_speed = 0.5
	stinger_sound = 'tff_modular/modules/vampire/sound/lunge_warn.ogg'
...
/datum/antagonist/vampire/apply_innate_effects(mob/living/mob_override)
	...
	current_mob.fully_replace_character_name(current_mob.name, ("Not Vampire:" + vampire_name))
...
/datum/antagonist/vampire/proc/on_examine(datum/source, mob/examiner, list/examine_text)
	...
	var/text
	if(prince)
		text = "<img class='icon' src='\ref['tff_modular/modules/vampire/icons/vampiric.dmi']?state=prince'> "
	else if(scourge)
		text = "<img class='icon' src='\ref['tff_modular/modules/vampire/icons/vampiric.dmi']?state=scourge'> "
	else
