...
/obj/structure/vampire/bloodthrone
	...
	icon = 'tff_modular/modules/vampire/icons/vamp_obj_64.dmi'
	icon_state = "throne"
	buckle_lying = 0
	anchored = FALSE
	density = TRUE
...
/obj/structure/vampire/bloodthrone/update_overlays()
	. = ..()
	if(has_buckled_mobs())
		var/mutable_appearance/armrest = mutable_appearance('tff_modular/modules/vampire/icons/vamp_obj_64.dmi', "thronearm")
...
/obj/structure/vampire/bloodthrone/proc/handle_speech(datum/source, list/speech_args)
	...
	var/icon_html = "<img class='icon' style='margin-right: -0.1em; transform: scale(1.85); image-rendering: pixelated; font-size: initial; vertical-align: middle;' src='\ref['tff_modular/modules/vampire/icons/vampiric.dmi']?state=[rank_icon_state]'>"
