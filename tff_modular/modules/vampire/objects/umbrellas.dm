...
/obj/item/umbrella
	...
	icon = 'tff_modular/modules/vampire/icons/umbrellas.dmi'
	icon_state = "umbrella"
	inhand_icon_state = "umbrella_closed"
	lefthand_file = 'tff_modular/modules/vampire/icons/umbrellas_inhand_lh.dmi'
	righthand_file = 'tff_modular/modules/vampire/icons/umbrellas_inhand_rh.dmi'
	force = 5
	throwforce = 5
	...
	drop_sound = 'tff_modular/modules/vampire/sound/wooden_drop.ogg'
	pickup_sound = 'tff_modular/modules/vampire/sound/wooden_pickup.ogg'
...
/obj/item/umbrella/Initialize(mapload)
	...
	AddComponent( \
		...
		force_on = 7, \
		hitsound_on = "sound/items/weapons/genhit1.ogg", \
