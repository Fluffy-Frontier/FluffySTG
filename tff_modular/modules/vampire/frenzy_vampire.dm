...
/datum/status_effect/frenzy/on_apply()
	...
	carbon_owner.playsound_local(null, 'tff_modular/modules/vampire/sound/rage_increase.ogg', 100, FALSE, pressure_affected = FALSE)
...
/datum/status_effect/frenzy/on_remove()
	...
	carbon_owner.playsound_local(null, 'tff_modular/modules/vampire/sound/rage_decrease.ogg', 100, FALSE, pressure_affected = FALSE)
