...
/datum/sprite_accessory/genital/penis/alt
	icon = 'tff_modular/modules/splurt_genitals/icons/penis_onmob.dmi'
...
/datum/sprite_accessory/genital/breasts/alt
	icon = 'tff_modular/modules/splurt_genitals/icons/breasts_onmob.dmi'
...
/datum/sprite_accessory/genital/testicles/alt
	icon = 'tff_modular/modules/splurt_genitals/icons/testicles_onmob.dmi'
	relevent_layers = list(BODY_ADJ_LAYER, BODY_BEHIND_LAYER)

/datum/sprite_accessory/genital/testicles/alt/pair
	name = "Pair (Alt)"
	icon_state = "pair"
	has_skintone_shading = TRUE
