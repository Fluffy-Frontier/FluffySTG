...
/turf/open/misc/moonstation_sand
	...
	icon = 'tff_modular/modules/moonstation/icons/lunar_sand.dmi'
	icon_state = "0,0"
...
/turf/open/misc/moonstation_rock
	...
	initial_gas_mix = MOONSTATION_ATMOS
	icon = 'tff_modular/modules/moonstation/icons/lunar_rock.dmi'
	icon_state = "0,0"
	planetary_atmos = TRUE
...
/turf/open/chasm/moonstation
	...
	icon = 'tff_modular/modules/moonstation/icons/moonchasm.dmi'
