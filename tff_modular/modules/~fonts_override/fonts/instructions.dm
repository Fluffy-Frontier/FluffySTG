...
/// Base font
/datum/font/instructions
	name = "Instructions"
	font_family = 'tff_modular/modules/~fonts_override/fonts/Instructions.ttf'

/// For icon overlays
/// Instructions 12pt metrics generated using Lummox's dmifontsplus (https://www.byond.com/developer/LummoxJR/DmiFontsPlus)
/// Note: these variable names have been changed, so you can't straight copy/paste from dmifontsplus.exe
/datum/font/instructions/size_12pt
	name = "Instructions 12pt"
	height = 13
	ascent = 11
	descent = 2
	average_width = 6
