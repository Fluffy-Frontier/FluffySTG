/proc/gay_vulpes_gib(mob/living/carbon/sweet_sweet_boy)
	...
	sleep(4 SECONDS)
	for(var/i = 1 to 3)
		var/replica = ((sweet_sweet_boy.gender == "male") ? "Мальчик!" : "Девочка!")
		horny1.say(replica)
		horny2.say(replica)
		horny3.say(replica)
		sleep(2 SECONDS)
	horny2.say("Я хочу расцеловать [(sweet_sweet_boy.gender == "male") ? "его" : "её"] сейчас же! Тащим!")
	sleep(1 SECONDS)
	...
	sleep(1 SECONDS)
	playsound(the_turf, 'sound/effects/kiss.ogg', 40, TRUE)
	sleep(0.5 SECONDS)
	playsound(the_turf, 'sound/effects/kiss.ogg', 40, TRUE)
	sleep(0.25 SECONDS)
	playsound(the_turf, 'sound/effects/assslap.ogg', 40, TRUE)
	playsound(the_turf, 'sound/effects/kiss.ogg', 40, TRUE)
	sleep(0.25 SECONDS)
	playsound(the_turf, 'sound/effects/kiss.ogg', 40, TRUE)
	playsound(the_turf, 'sound/effects/assslap.ogg', 40, TRUE)
	...
	sleep(1 SECONDS)
	playsound(the_turf, 'sound/effects/cartoon_splat.ogg', 80, TRUE)
	sleep(2 SECONDS)
	playsound(the_turf, 'sound/effects/cartoon_pop.ogg', 80, TRUE)
