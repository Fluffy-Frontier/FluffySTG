...
/obj/structure/mortar/attackby(obj/item/attacking_item, mob/living/user)
	if(istype(attacking_item, /obj/item/mortar_shell))
		...
		playsound(loc, 'tff_modular/modules/mortar/sound/gun_mortar_reload.ogg', 100, 1)
		busy = TRUE
		var/success = do_after(user, 1.5 SECONDS, src)
		busy = FALSE
		if(success)
			...
			playsound(loc, 'tff_modular/modules/mortar/sound/gun_mortar_fire.ogg', 200, 1)
			busy = FALSE
			firing = TRUE
...
/obj/structure/mortar/proc/handle_shell(turf/target, obj/item/mortar_shell/shell)
	playsound(target, 'tff_modular/modules/mortar/sound/gun_mortar_travel.ogg', 125, 1)
	var/relative_dir
...
/obj/item/mortar_kit/attack_self(mob/user)
	...
	if(do_after(user, 4 SECONDS, user))
		...
		playsound(deploy_turf, 'tff_modular/modules/mortar/sound/gun_mortar_unpack.ogg', 25, 1)
