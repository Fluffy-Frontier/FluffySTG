/datum/round_event_control/alien_infestation/tgmc
	...
	description = "A xenomorph larva spawns on a random vent. (These are from TGMC)"
...
/datum/round_event/ghost_role/alien_infestation/tgmc/spawn_role()
	...
	var/list/candidates = SSpolling.poll_ghost_candidates(check_jobban = ROLE_ALIEN, role = ROLE_ALIEN, alert_pic = /mob/living/carbon/alien/larva/tgmc, role_name_text = role_name)
	...
	while(spawncount > 0 && vents.len && candidates.len)
		...
		var/mob/living/carbon/alien/larva/tgmc/new_xeno = new(vent.loc)
