...
/datum/action/cooldown/spell/pointed/psionic/stasis/cast(atom/cast_on)
	...
	freezing.apply_status_effect(/datum/status_effect/freon/watcher)
	var/datum/status_effect/freon/watcher/status_effect = freezing.has_status_effect(/datum/status_effect/freon/watcher)
	status_effect.duration = 4 * cast_power
