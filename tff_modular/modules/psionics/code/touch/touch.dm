...
/datum/action/cooldown/spell/touch/psionic/psionic_assay
	name = "Psionic Assay"
...
/datum/action/cooldown/spell/touch/psionic/psionic_assay/cast_on_hand_hit(obj/item/melee/touch_attack/hand, atom/victim, mob/living/carbon/mendicant)
	if(ishuman(victim))
...
/datum/action/cooldown/spell/touch/psionic/psionic_assay/proc/read_psionic_level(mob/living/carbon/human/patient)
