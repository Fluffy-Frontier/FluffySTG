...
/mob/living/simple_animal/hostlie/little_slime
	name = "Маленький слизень"
	icon = 'tff_modular/modules/asdasvasdqwe/mobs/32x32.dmi'
	icon_state = "little_slime"

/mob/living/simple_animal/hostlie/big_slime
...
/mob/living/simple_animal/crawling_beast
	icon = 'tff_modular/modules/asdasvasdqwe/mobs/48x32.dmi'
	icon_state = "crawling_beast"

/mob/living/simple_animal/ravenous_beast
	icon = 'tff_modular/modules/asdasvasdqwe/mobs/48x32.dmi'
	icon_state = "ravenous_beast"

/mob/living/simple_animal/redbuddy
	icon = 'tff_modular/modules/asdasvasdqwe/mobs/48x48.dmi'
...
/mob/living/simple_animal/apex
	icon = 'tff_modular/modules/asdasvasdqwe/mobs/64x64.dmi'
	icon_state = "apex_old"

/mob/living/simple_animal/apex_b
	icon = 'tff_modular/modules/asdasvasdqwe/mobs/64x64.dmi'
	icon_state = "apex"
	//_crouch _leap
...
/mob/living/simple_animal/spider_violet
	icon = 'tff_modular/modules/asdasvasdqwe/mobs/64x64.dmi'
	icon_state = "spider_minion"

/mob/living/simple_animal/merm
	icon = 'tff_modular/modules/asdasvasdqwe/mobs/64x64.dmi'
	icon_state = "merm"
	//_open _tongue _dead

/mob/living/simple_animal/scarymerm
	icon = 'tff_modular/modules/asdasvasdqwe/mobs/64x64.dmi'
...
/mob/living/simple_animal/hostlie/melting
	name = "Сгусток слизи"
