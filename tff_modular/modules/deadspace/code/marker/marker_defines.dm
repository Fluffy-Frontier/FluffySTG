...
/obj/structure/marker
	...
	var/static/list/spooky_texts = list(
		"Мы голодны.",
		"Так пусто.",
		"Кто здесь?",
		"Ты слышал это?",
	...
	var/static/list/really_scary_texts = list(
		"ТЫ СТАНЕШЬ НАШИМ ОБЕДОМ.",
		"ТЕБЕ СДОХНЕШЬ ЗДЕСЬ И СЕЙЧАС.",
		"УМРИ УМРИ УМРИ УМРИ УМРИ УМРИ УМРИ УМРИ УМРИ УМРИ УМРИ УМРИ.",
		"МЫ ГОЛОДНЫ, ТЫ ПРИЯТНО ПАХНЕШЬ.",
		"МЫ ЗНАЕМ ГДЕ ТЫ. МЫ ВИДИМ ТЕБЯ. МЫ ИДЁм К ТЕБЕ.",
		"НЕ ДВИГАЙСЯ. НЕ ОГЛЯДЫВАЙСЯ. НЕ КРИЧИ О ПОМОЩИ.",
		"ВСЁ ТЩЕТНО. ТЕБЕ НЕКУДА БЕЖАТЬ.",
		"МЫ ИДЁМ ИСКАТЬ. КТО НЕ СПРЯТАЛСЯ, МЫ НЕ ВИНОВАТЫ.",
		"У ТЕБЯ БЫЛ ШАНС.",
		"ЭТО ВСЁ ТВОЯ ВИНА. ЭТО ВСЁ ТВОЯ ВИНА. ЭТО ВСЁ ТВОЯ ВИНА.",
