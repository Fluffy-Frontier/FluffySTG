#define CQD_HOLSTER_BLACKLIST_FILE "tff_modular/modules/cqd_holsters/holster_blacklist.txt"
#define CQD_HOLSTER_WHITELIST_FILE "tff_modular/modules/cqd_holsters/holster_whitelist.txt"
