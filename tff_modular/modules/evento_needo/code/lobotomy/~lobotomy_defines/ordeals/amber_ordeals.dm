...
/datum/ordeal/simplespawn/amber_dawn
	...
	level = 1
	reward_percent = 0.1
	announce_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/amber_start.ogg'
	end_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/amber_end.ogg'
	color = "#FFBF00"
	spawn_places = 4
	spawn_amount = 3
