...
/datum/ordeal/simplespawn/violet_dawn
	...
	announce_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/violet_start.ogg'
	end_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/violet_end.ogg'
	spawn_places = 4
	spawn_amount = 2
...
/datum/ordeal/violet_midnight/Run()
	..()
	var/list/available_spots = GLOB.generic_event_spawns.Copy()
