...
/datum/ordeal/simplespawn/indigo_dawn
	...
	announce_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/indigo_start.ogg'
	end_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/indigo_end.ogg'
	reward_percent = 0.1
	level = 1
	spawn_places = 5
	spawn_amount = 2
...
/datum/ordeal/indigo_specials/indigo_noon/Run()
	...
	var/meaningful_threats = living_player_count()
