...
/datum/ordeal/gold_dawn
	...
	level = 1
	reward_percent = 0.1
	announce_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/gold_start.ogg'
	end_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/gold_end.ogg'
	color = "#FFD700"
...
/datum/ordeal/gold_dawn/Run() // We want our own variant that spawns both groups of mobs and roamers
	...
	if(!LAZYLEN(GLOB.generic_event_spawns))
		...
		return
	var/boss_player_mod = round(living_player_count() * boss_player_multiplicator)
...
/datum/ordeal/gold_dawn/gold_midnight
	...
	level = 4
	reward_percent = 0.25
	end_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/gold_end_special.ogg' // I had 3 sound effects so I guess i'll use one here.
