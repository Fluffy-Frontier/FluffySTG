...
/datum/ordeal/boss/pink_midnight
	...
	level = 4
	reward_percent = 0.25
	announce_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/pink_start.ogg'
	end_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/pink_end.ogg'
	color = COLOR_PINK
