...
/datum/ordeal/crimson_dawn
	...
	level = 1
	reward_percent = 0.1
	announce_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/crimson_start.ogg'
	end_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/crimson_end.ogg'
	color = "#DC143C"
