...
/datum/ordeal/simplespawn/green_dawn
	...
	announce_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/green_start.ogg'
	end_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/green_end.ogg'
	spawn_places = 6
	spawn_amount = 1
	spawn_type = list(
