/datum/ordeal/fixers
	...
	random_delay = FALSE
	reward_percent = 0.1
	announce_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/white_start.ogg'
	end_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/white_end.ogg'
	var/mobs_amount = 1
