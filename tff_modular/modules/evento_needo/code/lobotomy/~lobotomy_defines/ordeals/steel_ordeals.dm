/datum/ordeal/simplespawn/steel_dawn
	...
	announce_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/steel_start.ogg'
	end_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/steel_end.ogg'
	level = 1
	reward_percent = 0.1
	spawn_places = 4
	spawn_amount = 2
