...
/mob/living/carbon/human/proc/show_aso_blurb(text)
	addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(show_blurb), client, 1 SECONDS, text, 1 SECONDS, "red", "black", "left", around_player), 20)
