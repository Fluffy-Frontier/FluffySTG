...
/mob/living/simple_animal/hostile/abnormality/rudolta_buff
	...
	pixel_x = -16
	base_pixel_x = -16
	damage_coeff = list(BURN = 0.4, BRAIN = 0.2, BRUTE = 1, TOX = 0.8)
	...
	attack_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/rudolta_buff/melee.ogg'
	...
	var/list/onrush_sounds = list(
		'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/rudolta_buff/onrush1.ogg',
		'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/rudolta_buff/onrush2.ogg',
		'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/rudolta_buff/onrush3.ogg',
	)
	// Sleigh slam vars
	var/slam_cooldown
...
/mob/living/simple_animal/hostile/abnormality/rudolta_buff/proc/OnRush(mob/living/target, iteration = 0)
	...
	var/list/line_list = get_line(src, target_turf)
	...
	target.apply_damage(onrush_damage, BRUTE)
...
/mob/living/simple_animal/hostile/abnormality/rudolta_buff/proc/SleighSlam(atom/target)
	...
	playsound(src, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/apocalypse/swing.ogg', 75, TRUE)
	...
	playsound(get_turf(src), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/mountain/slam.ogg', 75, TRUE, 7)
	for(var/turf/TF in range(3, T))
		if(TF.density)
			continue
		new /obj/effect/temp_visual/small_smoke/halfsecond(TF)
		been_hit = HurtInTurf(TF, been_hit, slam_damage, BRUTE, null, TRUE, FALSE, TRUE, TRUE)
