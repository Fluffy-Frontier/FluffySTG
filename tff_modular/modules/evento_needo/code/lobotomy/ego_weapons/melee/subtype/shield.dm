...
/obj/item/ego_weapon/shield
	...
	block_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/shield1.ogg'
...
/obj/item/ego_weapon/shield/proc/BlockFail(mob/living/carbon/human/user)
	...
	user.physiology.brain_mod *= 1.2
	user.physiology.brute_mod *= 1.2
	user.physiology.tox_mod *= 1.2
	if(QDELING(src))
		RemoveDebuff(user)
	else
...
/obj/item/ego_weapon/shield/Destroy()
	for(var/datum/timedevent/T in _active_timers)
