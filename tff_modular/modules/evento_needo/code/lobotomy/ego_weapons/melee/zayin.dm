...
/obj/item/ego_weapon/support/penitence
	...
	use_sound = "tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/onesin/bless.ogg"
	var/pulse_healing = -0.5

/obj/item/ego_weapon/support/penitence/Pulse(mob/living/carbon/human/user, count)
	..()
	for(var/mob/living/carbon/human/L in view(4, user))
		if(L.stat == DEAD || L == user) //no self-healing
			continue
...
/obj/item/ego_weapon/support/wingbeat
	...
	use_sound = "tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/fairyfestival/fairylaugh.ogg"
	var/pulse_healing = -0.5
...
/obj/item/ego_weapon/support/wingbeat/suicide_act(mob/living/carbon/user)
	...
	playsound(user, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/fairyfestival/fairy_festival_bite.ogg', 50, TRUE, -1)
...
/obj/item/ego_weapon/change/attack(mob/living/M, mob/living/user)
	if(!ishuman(M) || M == user || !user.faction_check_atom(M) || (!user.combat_mode))
		..()
		return
	...
	playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/change/change_end.ogg', 25, 0, -9)
...
/obj/item/ego_weapon/support/doze
	...
	attack_verb_continuous = list("slams", "strikes", "smashes")
	attack_verb_simple = list("slam", "strike", "smash")
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/happyteddy/teddy_guard.ogg'
	...
	use_sound = "tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/happyteddy/teddy_lullaby.ogg"
	var/pulse_healing = -2
...
/obj/item/ego_weapon/support/evening
	...
	use_sound = "tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/lighthammer/chain.ogg"
...
/obj/item/ego_weapon/cavernous_wailing
	...
	attack_verb_continuous = list("slams", "strikes", "smashes")
	attack_verb_simple = list("slam", "strike", "smash")
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/blubbering_toad/attack.ogg'
...
/obj/item/ego_weapon/cavernous_wailing/attack(mob/living/M, mob/living/user)
	...
	if(!istype(C))
		...
		return
	var/mob/living/carbon/human/HT = M
	playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/blubbering_toad/blurble3.ogg', 25, 0, -9) //change to blubber sfx when toad is merged
...
/obj/item/ego_weapon/plastic
	...
	attack_verb_continuous = list("smacks", "strikes", "beats")
	attack_verb_simple = list("smack", "strike", "beat")
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/kqe/hitsound1.ogg'
...
/obj/item/ego_weapon/prohibited/attack(mob/living/M, mob/living/user)
	...
	if(prob(75)) //75% chance of just not working at all - this ability has the potential to be OP
		return
	if(user.faction_check_atom(M) || (!istype(M, /mob/living/simple_animal/hostile)))
		return
...
/obj/item/ego_weapon/mirror
	...
	attack_verb_continuous = list("slices", "slashes", "stabs")
	attack_verb_simple = list("slice", "slash", "stab")
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/fixer/generic/wcorp4.ogg'
