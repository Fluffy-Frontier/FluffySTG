...
/obj/item/ego_weapon/city/ncorp_nail/attackby(obj/item/I, mob/living/user, params)
	...
	for(var/mob/living/M in marked)
		playsound(M, 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/fixer/generic/nail2.ogg', 100, FALSE, 4)
		M.apply_damage(I.force, I.damtype, null, M.run_armor_check(null, I.damtype), spread_damage = TRUE)
...
/obj/item/ego_weapon/city/ncorp_hammer/big
	...
	force = 60
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/shield1.ogg'
