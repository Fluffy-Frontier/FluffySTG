/obj/item/ego_weapon/city/devyat_trunk
	...
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/devyat_slice.ogg'
...
/obj/item/devyat_unlocker
	...
	icon = 'tff_modular/modules/evento_needo/icons/Teguicons/refiner.dmi'
	icon_state = "green"
...
/obj/item/ego_weapon/city/devyat_trunk/attack_hand(mob/user)
	if(owner && (user != owner))
		if(ishuman(user))
			...
			playsound(get_turf(src), 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/devyat_overclock.ogg', 25, 0, 4)
			theif.apply_damage(theif_damage, BRUTE)
		return FALSE
	. = ..()
...
/obj/item/ego_weapon/city/devyat_trunk/click_alt(mob/user)
	if(!CanUseEgo(user))
		return
	if(owner)
		if(user == owner)
...
/obj/item/ego_weapon/city/devyat_trunk/attack_self(mob/living/carbon/human/user)
	...
	if(combat_mode)
		...
		can_attack = FALSE
		user.physiology.burn_mod -= RR_armor
		user.physiology.brain_mod -= RR_armor
		user.physiology.brute_mod -= RR_armor
		user.physiology.tox_mod -= RR_armor
		if(do_after(user, 50, user))
			end_combat()
...
/obj/item/ego_weapon/city/devyat_trunk/proc/passive_courier_trunk(mob/living/user)
	if(combat_mode)
		...
		if(overclock)
			playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/devyat_alarm.ogg', 25, 0, 4)
		addtimer(CALLBACK(src, PROC_REF(passive_courier_trunk), user), 5 SECONDS)

/obj/item/ego_weapon/city/devyat_trunk/proc/gain_courier_trunk(amount, mob/living/user)
	if(overclock)
		user.apply_damage(courier_trunk * overclock_mult, BRUTE)
		if(user.stat == DEAD)
			playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/devyat_overclock_death.ogg', 50, 0, 4)
			end_combat()
			return
		else
			playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/devyat_overclock.ogg', 25, 0, 4)
	...
	if(courier_trunk >= tier3_threshold)
		...
		if(!tier3_vc_trigger)
			...
			playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/devyat_stage_up.ogg', 25, 0, 4)
...
/obj/item/ego_weapon/city/devyat_trunk/proc/entering_combat(mob/living/user)
	playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/devyat_combat_start.ogg', 50, 0, 4)
...
/obj/item/ego_weapon/city/devyat_trunk/proc/entering_stage_1(mob/living/user)
	playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/devyat_stage_1.ogg', 50, 0, 4)
...
/obj/item/ego_weapon/city/devyat_trunk/proc/entering_stage_2(mob/living/user)
	playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/devyat_stage_2.ogg', 50, 0, 4)
...
/obj/item/ego_weapon/city/devyat_trunk/proc/entering_stage_3(mob/living/user)
	playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/devyat_stage_3.ogg', 50, 0, 4)
