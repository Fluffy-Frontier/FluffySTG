...
/obj/item/ego_weapon/city/mirae
	...
	force = 50
	damtype = BRUTE	//Also does a small bit of pale, because lawyers hurt your mind and soul.
...
/obj/item/ego_weapon/city/mirae/attack(mob/living/target, mob/living/carbon/human/user)
	...
	if(target.stat != DEAD)
		living = TRUE
	target.apply_damage(force*0.2, BRUTE, null, target.run_armor_check(null, BRUTE), spread_damage = TRUE)
	..()
...
/obj/item/ego_weapon/city/mirae/page
	...
	force = 45
	damtype = BRUTE	//Also does a small bit of pale, because lawyers eat your soul.
