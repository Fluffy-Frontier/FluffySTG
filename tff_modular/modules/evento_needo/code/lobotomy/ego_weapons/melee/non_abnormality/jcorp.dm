...
/obj/item/ego_weapon/city/mariachi
	...
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/fixer/generic/maracas1.ogg'
	var/poise = 0
...
/obj/item/ego_weapon/city/mariachi/attack_self(mob/user)
	...
	if(istype(Y))
		...
		playsound(src, 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/fixer/generic/maracas_shake.ogg', 50, TRUE)
	else
...
/obj/item/ego_weapon/city/mariachi_blades
	...
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/fixer/generic/blade1.ogg'
