...
/datum/action/item_action/miragestorm/Trigger(trigger_flags, atom/target)
...
/obj/item/ego_weapon/city/pt/proc/exchange_armaments(mob/user)
	...
	if(selected_armament)
		...
		qdel(src)
		user.put_in_hands(Y)
		playsound(user, 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/purple_tear/change.ogg', 50, 1)
...
/obj/item/ego_weapon/city/pt/slash
	...
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/purple_tear/slash1.ogg'
...
/obj/item/ego_weapon/city/pt/slash/attack(mob/living/target, mob/living/user)
	if(sheathed)
		...
		hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/purple_tear/slash3.ogg'
	..()
...
/obj/item/ego_weapon/city/pt/pierce
	...
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/purple_tear/stab1.ogg'
...
/obj/item/ego_weapon/city/pt/pierce/attack(mob/living/target, mob/living/user)
	if(sheathed)
		...
		hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/purple_tear/stab2.ogg'
	..()
	if(sheathed)
		sheathed = FALSE
		icon_state = "ptpierce"
...
/datum/status_effect/pt_lacerate/on_apply() //Notes: Future plan make this slow you down as well.
	...
	if(ishuman(owner))
		...
		L.physiology.burn_mod *= 2
		L.physiology.brain_mod *= 2
		L.physiology.brute_mod *= 2
		L.physiology.tox_mod *= 2
		return
...
/obj/item/ego_weapon/city/pt/blunt
	...
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/purple_tear/blunt1.ogg'
...
/obj/item/ego_weapon/city/pt/blunt/attack(mob/living/target, mob/living/user)
	if(sheathed)
		...
		hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/purple_tear/blunt2.ogg'
	..()
	if(sheathed)
		sheathed = FALSE
		icon_state = "ptblunt"
...
/obj/item/ego_weapon/city/pt/guard/proc/AnnounceBlock(mob/living/carbon/human/source, damage, damagetype, def_zone)
	...
	playsound(get_turf(src), 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/purple_tear/guard.ogg', 50, 0, 7)
...
/obj/item/ego_weapon/city/pt/proc/MirageStorm(mob/living/user)
	...
	attack_verb_continuous = list("slashes", "rends")
	attack_verb_simple = list("slash", "rend")
	hitsound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/purple_tear/slash2.ogg'
