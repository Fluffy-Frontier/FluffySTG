...
/obj/item/ego_weapon/ranged/hatred
	...
	weapon_weight = WEAPON_HEAVY
	fire_delay = 15
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/hatredqueen/attack.ogg'
...
/obj/item/ego_weapon/ranged/magicbullet
	...
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/freischutz/shoot.ogg'
...
/obj/item/ego_weapon/ranged/pistol/solemnlament
	...
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/funeral/spiritgunwhite.ogg'
...
/obj/item/ego_weapon/ranged/pistol/solemnvow
	...
	shotsleft = 18
	reloadtime = 0.7 SECONDS
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/funeral/spiritgunblack.ogg'
	fire_sound_volume = 30
	var/cached_multiplier
...
/obj/item/ego_weapon/ranged/pistol/crimson
	...
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/redhood/fire.ogg'
...
/obj/item/ego_weapon/ranged/ecstasy
	...
	weapon_weight = WEAPON_MEDIUM
	spread = 40
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/ecstasy.ogg'
	autofire = 0.08 SECONDS
	shotsleft = 40
...
/obj/item/ego_weapon/ranged/aroma
	...
	weapon_weight = WEAPON_HEAVY
	fire_delay = 25
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/crossbow.ogg'
...
/obj/item/ego_weapon/ranged/warring/attack_self(mob/user)
	switch(drawn)
		...
		if(1)
			...
			fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/thunderbird/tbird_beam.ogg'
...
/obj/item/ego_weapon/ranged/banquet
	...
	shotsleft = 7
	reloadtime = 1.6 SECONDS
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/ego/cannon.ogg'
...
/obj/item/ego_weapon/ranged/pistol/innocence
	...
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/orangetree/ding.ogg'
...
/obj/item/ego_weapon/ranged/hypocrisy/attack_self(mob/living/carbon/user)
	...
	if(do_after(user, 3 SECONDS, src))
		if(trap_cooldown >= world.time)
			...
			return
		playsound(get_turf(user), 'sound/mobs/non-humanoids/venus_trap/venus_trap_hurt.ogg', 50, TRUE)
...
/obj/structure/liars_trap/Initialize()
	...
	var/static/list/loc_connections = list(
		COMSIG_ATOM_ENTERED = PROC_REF(entered)
	)
	AddElement(/datum/element/connect_loc, loc_connections)

/obj/structure/liars_trap/proc/entered(atom/movable/arrived, atom/old_loc, list/atom/old_locs)
	if(isliving(arrived))
		var/mob/living/L = arrived
		if(!faction_check(faction, L.faction))
			playsound(get_turf(src), 'sound/machines/clockcult/steam_whoosh.ogg', 10, 1)
			L.apply_damage(50, BRUTE, null, L.run_armor_check(null, BRUTE), spread_damage = FALSE)
...
/obj/item/ego_weapon/ranged/fellbullet
	...
	shotsleft = 1
	reloadtime = 0.5 SECONDS
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/fluchschutze/fell_bullet.ogg'
	var/portaling = FALSE
	var/portal_cooldown
...
/obj/item/ego_weapon/ranged/fellbullet/click_alt(mob/user)
	..()
	if(semicd)
		return
...
/obj/item/ego_weapon/ranged/fellbullet/afterattack(atom/target, mob/living/user, flag, params)
	...
	if(portaling)
		...
		P1.link_portal(P2)
		P2.link_portal(P1)
		playsound(src, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/fluchschutze/fell_magic.ogg', 50, TRUE)
...
/obj/item/ego_weapon/ranged/fellbullet/reload_ego(mob/user)
	...
	if(myportal in user)//is it not qdeleted?
		...
		playsound(src, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/fluchschutze/fell_portal.ogg', 50, FALSE)
	is_reloading = TRUE
	to_chat(user,span_notice("You chamber a round into [src]."))
	playsound(src, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/fluchschutze/fell_aim.ogg', 50, TRUE)
...
/obj/effect/portal/fellbullet/teleport(atom/movable/M, force = FALSE)
	...
	for(var/obj/effect/portal/fellbullet/P in real_target)
		...
		playsound(P, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/fluchschutze/fell_portal.ogg', 50, TRUE)
		playsound(P, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/fluchschutze/fell_bullet2.ogg', 50, TRUE)
	..()
...
/obj/item/ego_weapon/ranged/fellscatter
	...
	shotsleft = 4
	reloadtime = 0.5 SECONDS
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/fluchschutze/fell_scatter.ogg'
...
/obj/item/ego_weapon/ranged/fellscatter/click_alt(mob/user)
	..()
	if(semicd)
		return
	return reload_ego(user)
...
/obj/item/ego_weapon/ranged/fellscatter/reload_ego(mob/user)
	...
	if(do_after(user, reloadtime, src)) //gotta reload
		playsound(src, 'sound/items/weapons/gun/shotgun/insert_shell.ogg', 50, TRUE)
		shotsleft +=1
		reload_ego(user)
	is_reloading = FALSE
...
/obj/item/ego_weapon/ranged/fellscatter/attack_self(mob/user)
	if(special_ammo)
		...
		return
	if(shotsleft > 1)
		playsound(user, 'sound/items/weapons/gun/general/mag_bullet_remove.ogg', 50, TRUE)
