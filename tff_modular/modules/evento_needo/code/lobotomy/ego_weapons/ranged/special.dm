...
/obj/item/ego_weapon/ranged/flammenwerfer/attack_self(mob/user)
	...
	if(do_after(H, 12, src))
		...
		H.playsound_local(get_turf(H), 'sound/items/weapons/lasercannonfire.ogg', 100, 0)
		H.apply_damage(10, BRUTE, null, H.run_armor_check(null, BRUTE), spread_damage = TRUE)
...
/obj/item/ego_weapon/ranged/hatred_nihil/attack_self(mob/user)
	...
	if(do_after(user, 15, src))
		...
		playsound(src, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/hatredqueen/gun.ogg', 65, FALSE, 4)
