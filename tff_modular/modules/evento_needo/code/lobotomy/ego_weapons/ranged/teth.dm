...
/obj/item/ego_weapon/ranged/wishing_cairn
	...
	fire_delay = 3
	burst_size = 2
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/pagoda/throw.ogg'
...
/obj/item/ego_weapon/ranged/wishing_cairn/proc/Ammo_Change()
	...
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/pagoda/throw2.ogg'
...
/obj/item/ego_weapon/ranged/aspiration
	...
	fire_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/fragment/attack.ogg'
...
/obj/item/ego_weapon/ranged/pistol/tough/attack_self(mob/user)
	...
	H.playsound_local(get_turf(H), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/wrath_servant/hermit_magic.ogg', 25, 0)
	BaldBlast(user)
...
/obj/item/ego_weapon/ranged/pistol/tough/proc/BaldBlast(mob/living/carbon/human/user ,list/baldtargets = list(), burst_chain)
	for(var/mob/living/carbon/human/L in view(5, user)) //not even the dead are safe.
		if(!ishuman(L))
			continue
