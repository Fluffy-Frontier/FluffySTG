...
/obj/projectile/ego_bullet/ego_match/on_hit(atom/target, blocked = FALSE, pierce_hit)
	..()
...
/obj/projectile/ego_bullet/ego_wishing/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
...
/obj/projectile/ego_bullet/ego_aspiration/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
	if(!isliving(target))
		return
	...
	if(user.faction_check_atom(T)) // Our faction
...
/obj/projectile/ego_bullet/ego_adjustment/on_hit(atom/target, blocked = FALSE, pierce_hit)
	if(ishuman(target))
