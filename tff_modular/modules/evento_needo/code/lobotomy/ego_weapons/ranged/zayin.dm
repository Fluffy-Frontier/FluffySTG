...
/obj/item/ego_weapon/ranged/pistol/soda/proc/ShrimpFuneral(mob/user)
	...
	if(istype(S))
		user.playsound_local(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/wellcheers/shrimptaps.ogg', 50, 0)
		for(var/i in 1 to 2)
...
/obj/item/ego_weapon/ranged/pistol/nostalgia/attack_self(mob/user)
	...
	if(istype(N))
		...
		H.playsound_local(get_turf(H), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/old_lady/oldlady_debuff.ogg', 25, 0)
		HealPulse(user, 0)
	else
		pulse_enabled = FALSE
...
/obj/item/ego_weapon/ranged/bucket/attack_self(mob/user)
	...
	H.playsound_local(get_turf(H), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/bloodbath/Bloodbath_EyeOn.ogg', 25, 0)
	SpawnItem(user)
