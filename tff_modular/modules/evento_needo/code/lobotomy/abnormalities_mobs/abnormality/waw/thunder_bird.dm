...
/mob/living/simple_animal/hostile/abnormality/thunder_bird/death()
	...
	density = FALSE
	playsound(src, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/thunderbird/tbird_charge.ogg', 100, 1)
...
/mob/living/simple_animal/hostile/abnormality/thunder_bird/proc/do_dash(move_dir, times_ran)
	...
	if(stop_charge)
		playsound(src, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/thunderbird/tbird_bolt.ogg', 75, 1)
		charging = FALSE
		icon_state = "thunderbird_breach"
		return
	forceMove(T)
	playsound(src,"tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/thunderbird/tbird_peck.ogg", rand(50, 70), 1)
	...
	for(var/obj/vehicle/sealed/mecha/V in turfs_to_hit)
		...
		V.take_damage(100, BRUTE, attack_dir = get_dir(V, src))
		been_hit += V
...
/mob/living/simple_animal/hostile/abnormality/thunder_bird/SuccessEffect(mob/living/carbon/human/user)
	if(user.health > (user.maxHealth*0.8))
		qliphoth_change(1)
		user.apply_damage(45, BRUTE)
...
/mob/living/simple_animal/hostile/abnormality/thunder_bird/FailureEffect(mob/living/carbon/human/user)
	qliphoth_change(-1)
	return
...
/obj/effect/thunderbolt/proc/Explode()
	playsound(get_turf(src), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/thunderbird/tbird_bolt.ogg', 50, 0, 8)
	...
	for(var/obj/vehicle/V in turfs_to_check)
		V.take_damage(boom_damage, BRUTE)
...
/mob/living/simple_animal/hostile/thunder_zombie
	...
	maxHealth = 250
	obj_damage = 60
	damage_coeff = list(BURN = 1, BRAIN = 1.5, BRUTE = 0.5, TOX = 0.5)
	melee_damage_type = BRUTE
...
/mob/living/simple_animal/hostile/thunder_zombie/Initialize()
	...
	playsound(get_turf(src), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/thunderbird/tbird_charge.ogg', 50, 1, 4)
