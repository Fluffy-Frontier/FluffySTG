...
/mob/living/simple_animal/hostile/senior_shrimp
	...
	maxHealth = 1337
	melee_damage_type = BRUTE
	damage_coeff = list(BURN = 0.8, BRAIN = 1.5, BRUTE = 1, TOX = 2)
...
/mob/living/simple_animal/hostile/senior_shrimp/Initialize()
	. = ..()
	AddElement(/datum/element/knockback, 3, FALSE, FALSE)
...
/mob/living/simple_animal/hostile/ordeal/salmon_dusk/red
	...
	icon_living = "wellcheers_bad"
	melee_damage_type = BRUTE
	damage_coeff = list(BURN = 0.2, BRAIN = 0.8, BRUTE = 1.5, TOX = 1)
	ranged = 5
	rapid = 20
...
/mob/living/simple_animal/hostile/ordeal/salmon_dusk/white
	...
	icon_living = "wellcheers_bad"
	melee_damage_type = BRUTE
	damage_coeff = list(BURN = 1, BRAIN = 0.2, BRUTE = 0.8, TOX = 1.5)
	ranged = 2.5
	move_to_delay = 5
...
/mob/living/simple_animal/hostile/ordeal/salmon_dusk/black
	...
	icon_living = "wellcheers_bad"
	melee_damage_type = BRUTE
	damage_coeff = list(BURN = 1.5, BRAIN = 1, BRUTE = 0.2, TOX = 0.8)
	rapid_melee = 4
	move_to_delay = 2.4
	...
	attack_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/weapons/purple_tear/stab2.ogg'
	var/fast_mode = FALSE
...
// Modified patrolling
/mob/living/simple_animal/hostile/ordeal/salmon_dusk/black/handle_automated_movement()
	fast_mode = TRUE
...
/mob/living/simple_animal/hostile/ordeal/salmon_dusk/pale
	...
	melee_damage_upper = 12
	damage_coeff = list(BURN = 0.8, BRAIN = 1.5, BRUTE = 1, TOX = 0.2)
	ranged = 1
	retreat_distance = 2
	minimum_distance = 3
...
/mob/living/simple_animal/hostile/ordeal/salmon_midnight
	...
	health = 4000
	move_to_delay = 3
	damage_coeff = list(BURN = 0.5, BRAIN = 0.5, BRUTE = 0.5, TOX = 1)
