...
/mob/living/simple_animal/hostile/ordeal/green_bot_big
	...
	attack_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/green/saw.ogg'
	...
	projectilesound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/green/fire.ogg'
	death_sound = 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/green/noon_dead.ogg'
...
/mob/living/simple_animal/hostile/ordeal/green_bot_big/AttackingTarget(atom/attacked_target)
	...
	if(.)
		...
		for(var/i = 1 to 4)
			...
			HurtInTurf(T, list(), 8, BRUTE, check_faction = TRUE, hurt_mechs = TRUE)
...
/mob/living/simple_animal/hostile/ordeal/green_bot_big/proc/StartReloading()
	...
	playsound(get_turf(src), 'tff_modular/modules/evento_needo/sounds/Tegusounds/ordeals/green/cooldown.ogg', 50, FALSE)
	for(var/i = 1 to 8)
