/mob/living/simple_animal/hostile/abnormality/oceanicwaves
	...
	damage_coeff = list(BURN = 1.2, BRAIN = 1.2, BRUTE = 0.8, TOX = 0.8)
	...
	var/list/goodsoders = list(
		/obj/item/reagent_containers/cup/soda_cans/oceanwave/unlabeled,
		/obj/item/reagent_containers/cup/soda_cans/oceanwave/cola,
		/obj/item/reagent_containers/cup/soda_cans/oceanwave/coffee,
		/obj/item/reagent_containers/cup/soda_cans/oceanwave/milk,
		/obj/item/reagent_containers/cup/soda_cans/oceanwave/ultimate,
	)
	var/list/badsoders = list(
		/obj/item/reagent_containers/cup/soda_cans/oceanwave/cocaine,
		/obj/item/reagent_containers/cup/soda_cans/oceanwave/lean,
		/obj/item/reagent_containers/cup/soda_cans/oceanwave/whale,
		/obj/item/reagent_containers/cup/soda_cans/oceanwave/cocktail,
		/obj/item/reagent_containers/cup/soda_cans/oceanwave/hootch,
	)
	var/currentvend

//Shrimple work stuff
/mob/living/simple_animal/hostile/abnormality/oceanicwaves/SuccessEffect(mob/living/carbon/human/user)
	//Randomize the soders then vend.
	switch(rand(1, 10))
		if(1 to 2)
			currentvend = pick(badsoders)
		if(2 to 5)
			currentvend = /obj/item/reagent_containers/cup/soda_cans/oceanwave
		else
...
/mob/living/simple_animal/hostile/abnormality/oceanicwaves/FailureEffect(mob/living/carbon/human/user)
	switch(rand(1, 10))
		if(1 to 6)
			currentvend = pick(badsoders)
		if(6 to 9)
...
/mob/living/simple_animal/hostile/abnormality/oceanicwaves/proc/Vend(obj/item/reagent_containers/cup/soda_cans/VendingSoda)
...
//Obvious copypaste
/mob/living/simple_animal/hostile/abnormality/oceanicwaves/proc/HostileVend(obj/item/reagent_containers/cup/soda_cans/VendingSoda, mob/living/carbon/human/the_target, count)
	if(!count || !the_target)
		return
	playsound(src, 'sound/machines/machine_vend.ogg', 50, TRUE)
	...
	P.set_angle(get_angle(src, the_target))
	P.fire()
...
/mob/living/simple_animal/hostile/abnormality/oceanicwaves/BreachEffect(mob/living/carbon/human/user)
	can_breach = TRUE
	return ..()
...
/obj/projectile/oceanic/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
	handle_drop()
...
// Good Soders
/obj/item/reagent_containers/cup/soda_cans/oceanwave
