...
/mob/living/simple_animal/hostile/abnormality/sleeping
	...
	maxHealth = 450
	health = 450
	damage_coeff = list(BURN = 1, BRAIN = 0.5, BRUTE = 1, TOX = 2)
	del_on_death = FALSE
...
/mob/living/simple_animal/hostile/abnormality/sleeping/examine(mob/user)
	. = ..()
	. += "The couch looks inviting, softer and plusher than anything you've ever known. <br>You've been working for so long, it couldn't hurt to take a break?"

//work code
/mob/living/simple_animal/hostile/abnormality/sleeping/try_working(mob/living/carbon/human/user)
	. = ..()
	if(!.)
		return
	chance = 10
