...
/mob/living/simple_animal/hostile/abnormality/wellcheers/SuccessEffect(mob/living/carbon/human/user)
...
// Death!
/mob/living/simple_animal/hostile/abnormality/wellcheers/FailureEffect(mob/living/carbon/human/user)
	// Visual effects
	...
	// Actual effects
	playsound(get_turf(src), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/wellcheers/ability.ogg', 75, 0)
...
/mob/living/simple_animal/hostile/abnormality/wellcheers/OpenFire(atom/A)
	...
	switch(projectiletype)
		if(/obj/projectile/wellcheers/white)
			ChangeResistances(list(BURN = 1, BRAIN = 0.5, BRUTE = 1, TOX = 1))
		if(/obj/projectile/wellcheers/purple)
			ChangeResistances(list(BURN = 1, BRAIN = 1, BRUTE = 1, TOX = 0.5, BRUTE = 1))
		if(/obj/projectile/wellcheers)
			ChangeResistances(list(BURN = 1, BRAIN = 0.5, BRUTE = 1, TOX = 1, BRUTE = 1))
		else
...
/datum/status_effect/wellcheers_bad/tick()
	...
	owner.apply_damage(debuff_damage, damage_type)
...
/turf/open/water/deep/saltwater/extradeep/proc/Drown(mob/living/carbon/human/H)
	...
	sleep(3 SECONDS)
	playsound(src, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/dreamingcurrent/dead.ogg', 80, TRUE, -3)
