...
/obj/item/clothing/mask/facehugger/bongy/Leap(mob/living/M)
	. = ..()
	if(.)
		playsound(src, 'tff_modular/modules/evento_needo/sounds/Tegusounds/lc13_creatures/bongy/kweh.ogg', 70, TRUE)
...
/obj/item/clothing/mask/facehugger/bongy/equipped(mob/M, slot)
	. = ..()
...
/obj/item/clothing/mask/facehugger/bongy/proc/handle_speech(datum/source, list/speech_args)
	SIGNAL_HANDLER
	...
	playsound(get_turf(src), "tff_modular/modules/evento_needo/sounds/Tegusounds/lc13_creatures/bongy/chatter[pick(1,3)].ogg", 25, 0)
