...
/obj/structure/toolabnormality/promise/proc/SuccessEffect() //Success Effects
	...
	RotateVFX()
	playsound(src.loc, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/promise/process.ogg', 100, FALSE)
	sleep(3 SECONDS)
	playsound(src.loc, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/promise/marble.ogg', 100, FALSE)
	sleep(3 SECONDS)
	playsound(src.loc, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/promise/marble.ogg', 100, FALSE)
	sleep(3 SECONDS)
	playsound(src.loc, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/promise/result.ogg', 100, FALSE)
	sleep(1 SECONDS)
	playsound(src.loc, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/promise/success.ogg', 125, FALSE)
...
/obj/structure/toolabnormality/promise/proc/FailureEffect() //Failure Effects
	...
	playsound(src.loc, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/promise/result.ogg', 100, FALSE)
	sleep(1 SECONDS)
	playsound(src.loc, 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/promise/fail.ogg', 125, FALSE)
