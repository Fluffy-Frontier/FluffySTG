/mob/living/simple_animal/hostile/abnormality/watchman
	...
	rapid_melee = 2
	move_to_delay = 6
	damage_coeff = list(BURN = 1, BRAIN = 1.2, BRUTE = 0.5, TOX = 2)
...
/mob/living/simple_animal/hostile/abnormality/watchman/FailureEffect(mob/living/carbon/human/user)
	qliphoth_change(-1)
	return
...
/mob/living/simple_animal/hostile/abnormality/watchman/PostWorkEffect(mob/living/carbon/human/user)
...
/mob/living/simple_animal/hostile/abnormality/watchman/Goto(target, delay, minimum_distance)
	. = ..()
	HandleSpeech()
