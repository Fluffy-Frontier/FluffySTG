/obj/item/clothing/suit/armor/ego_gear/city/masquerade_cloak
	...
	icon = 'tff_modular/modules/evento_needo/icons/Teguicons/blood_fiend_gear.dmi'
	worn_icon = 'tff_modular/modules/evento_needo/icons/Teguicons/blood_fiend_gear_worn.dmi'
	//new_armor = list(BURN = 40, BRAIN = 20, BRUTE = 40, TOX = 20)
	...
	actions_types = list(
		/datum/action/cooldown/spell_action/bloodfeast,
		/datum/action/cooldown/spell_action/bloodart
	)
...
/datum/action/cooldown/spell_action/bloodfeast
	...
	button_icon_state = "lc_bleed"
	base_icon_state = "lc_bleed"
	cooldown_time = 5 SECONDS

/datum/action/cooldown/spell_action/bloodfeast/Activate(target, mob/user)
	playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/nosferatu/bloodcollect.ogg', 25, 0, 4)
	if (ishuman(user))
...
/datum/action/cooldown/spell_action/bloodart/Activate(target, mob/user)
	playsound(get_turf(user), 'tff_modular/modules/evento_needo/sounds/Tegusounds/abnormalities/nosferatu/bloodcollect.ogg', 25, 0, 4)
	if (ishuman(user))
		var/mob/living/carbon/human/wielder = user
		var/obj/item/clothing/suit/armor/ego_gear/city/masquerade_cloak/S = wielder.get_item_by_slot(ITEM_SLOT_OCLOTHING)
...
/datum/action/cooldown/spell_action/bloodart/proc/ResetArmor(obj/item/clothing/suit/armor/ego_gear/city/masquerade_cloak/A)
...
/obj/item/clothing/suit/armor/ego_gear/city/masquerade_cloak/masquerade_coat
	...
	bloodfeast_max = 100
	new_armor = list(BURN = 30, BRAIN = 20, BRUTE = 10, TOX = 0)
	hat = null
	neck = null
