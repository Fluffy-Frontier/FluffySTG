...
/obj/item/clothing/suit/armor/ego_gear/zayin
	icon = 'tff_modular/modules/evento_needo/icons/Teguicons/ego_gear/abnormality/zayin.dmi'
	worn_icon = 'tff_modular/modules/evento_needo/icons/Teguicons/clothing/ego_gear/abnormality/zayin.dmi'
...
/obj/item/clothing/suit/armor/ego_gear/zayin/penitence
	...
	new_armor = list(BURN = 0, BRAIN = 10, BRUTE = 0, TOX = 0)
...
/obj/item/clothing/suit/armor/ego_gear/zayin/tough
	...
	icon_state = "tough"
	new_armor = list(BURN = 0, BRAIN = 0, BRUTE = 10, TOX = 0)
...
/obj/item/clothing/suit/armor/ego_gear/zayin/soda
	...
	icon_state = "soda"
	new_armor = list(BURN = 10, BRAIN = 0, BRUTE = 0, TOX = 0)
...
/obj/item/clothing/suit/armor/ego_gear/zayin/evening
	...
	icon_state = "evening"
	new_armor = list(BURN = 0, BRAIN = 0, BRUTE = 0, TOX = 10)
