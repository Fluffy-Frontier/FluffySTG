...
/obj/item/clothing/suit/armor/ego_gear/teth
	icon = 'tff_modular/modules/evento_needo/icons/Teguicons/clothing/ego_gear/abnormality/teth.dmi'
	worn_icon = 'tff_modular/modules/evento_needo/icons/Teguicons/mob/ego_gear/abnormality/teth.dmi'

/obj/item/clothing/suit/armor/ego_gear/teth/training
	name = "standard training armor"
	desc = "E.G.O intended for Manager Education"
	icon_state = "training"
	new_armor = list(BURN = 40, BRAIN = 0, BRUTE = -40, TOX = 0) // 0
...
/obj/item/clothing/suit/armor/ego_gear/teth/beak
	...
	icon_state = "beak"
	new_armor = list(BURN = 30, BRAIN = 10, BRUTE = -20, TOX = 0) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/match
	...
	icon_state = "match"
	new_armor = list(BURN = 40, BRAIN = -20, BRUTE = -20, TOX = 0, FIRE = 30) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/daredevil
	...
	new_armor = list(BURN = 30, BRAIN = 20, BRUTE = 20, TOX = -50) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/sorrow
	...
	icon_state = "sorrow"
	new_armor = list(BURN = -20, BRAIN = 30, BRUTE = 10, TOX = 0)

/obj/item/clothing/suit/armor/ego_gear/teth/solitude
	name = "solitude"
	desc = "Conversation is meaningless."
	icon_state = "solitude"
	new_armor = list(BURN = -30, BRAIN = 30, BRUTE = 20, TOX = 0)
...
/obj/item/clothing/suit/armor/ego_gear/teth/wrist
	...
	icon_state = "wrist"
	new_armor = list(BURN = 10, BRAIN = 30, BRUTE = -20, TOX = 0)
...
/obj/item/clothing/suit/armor/ego_gear/teth/blossoms
	...
	icon_state = "blossoms"
	new_armor = list(BURN = 20, BRAIN = 30, BRUTE = -30, TOX = 0)
...
/obj/item/clothing/suit/armor/ego_gear/teth/cute
	...
	icon_state = "cute"
	new_armor = list(BURN = 30, BRAIN = -20, BRUTE = 10, TOX = 0) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/shy
	...
	icon_state = "shy"
	new_armor = list(BURN = 30, BRAIN = 20, BRUTE = -30, TOX = 0)
...
/obj/item/clothing/suit/armor/ego_gear/teth/trick
	...
	icon_state = "trick"
	new_armor = list(BURN = 10, BRAIN = -20, BRUTE = 30, TOX = 0)

/obj/item/clothing/suit/armor/ego_gear/teth/sorority
	name = "sorority"
	desc = "Call upon your bretheren to fight."
	icon_state = "sorority"
	new_armor = list(BURN = -10, BRAIN = 30, BRUTE = 0, TOX = 0)
...
/obj/item/clothing/suit/armor/ego_gear/teth/lantern
	...
	icon_state = "lantern"
	new_armor = list(BURN = 10, BRAIN = 20, BRUTE = -10, TOX = 0) //20
...
/obj/item/clothing/suit/armor/ego_gear/teth/lantern/attack_self(mob/user)
	on = !on
	playsound(user, on ? 'sound/items/weapons/magin.ogg' : 'sound/items/weapons/magout.ogg', 30, TRUE)
	set_light_on(on)
	return 1
...
/obj/item/clothing/suit/armor/ego_gear/teth/curfew
	...
	icon_state = "curfew"
	new_armor = list(BURN = -20, BRAIN = 20, BRUTE = 0, TOX = 20) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/page
	...
	icon_state = "page"
	new_armor = list(BURN = -20, BRAIN = 10, BRUTE = 30, TOX = 0) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/wishing_cairn
	...
	new_armor = list(BURN = 0, BRAIN = -10, BRUTE = 10, TOX = 20) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/sloshing
	...
	icon_state = "sloshing"
	new_armor = list(BURN = 30, BRAIN = -10, BRUTE = 0, TOX = 0) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/red_sheet
	...
	new_armor = list(BURN = 0, BRAIN = -10, BRUTE = 30, TOX = 0) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/capote
	...
	icon_state = "capote"
	new_armor = list(BURN = 40, BRAIN = -30, BRUTE = -10, TOX = 0, FIRE = 30) // 0
...
/obj/item/clothing/suit/armor/ego_gear/teth/patriot
	...
	icon_state = "patriot"
	new_armor = list(BURN = 30, BRAIN = -20, BRUTE = 0, TOX = 10) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/faelantern
	...
	new_armor = list(BURN = 20, BRAIN = 30, BRUTE = -30, TOX = 0) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/luckdraw
	...
	icon_state = "luckdraw"
	new_armor = list(BURN = 0, BRAIN = 10, BRUTE = 30, TOX = -20) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/clayman
	...
	new_armor = list(BURN = 10, BRAIN = 10, BRUTE = -10, TOX = 10)
...
/obj/item/clothing/suit/armor/ego_gear/teth/desert
	...
	icon_state = "desert"
	flags_inv = NONE
	new_armor = list(BURN = 40, BRAIN = 0, BRUTE = -20, TOX = -20, FIRE = 30) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/white_gossypium
	...
	new_armor = list(BURN = 30, BRAIN = 30, BRUTE = -40, TOX = 0, FIRE = 0) //20. Made out of flammable cotton so fire resist sucks ass.
