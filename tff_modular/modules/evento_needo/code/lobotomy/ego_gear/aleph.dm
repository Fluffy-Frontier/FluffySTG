...
/obj/item/clothing/suit/armor/ego_gear/aleph
	icon = 'tff_modular/modules/evento_needo/icons/Teguicons/ego_gear/abnormality/aleph.dmi'
	worn_icon = 'tff_modular/modules/evento_needo/icons/Teguicons/clothing/ego_gear/abnormality/aleph.dmi'
...
/obj/item/clothing/suit/armor/ego_gear/aleph/paradise
	...
	icon_state = "paradise"
	new_armor = list(BURN = 70, BRAIN = 70, BRUTE = 70, TOX = 70) // 280
...
/obj/item/clothing/suit/armor/ego_gear/aleph/justitia
	...
	icon_state = "justitia"
	new_armor = list(BURN = 60, BRAIN = 50, BRUTE = 50, TOX = 80) // 240
...
/obj/item/clothing/suit/armor/ego_gear/aleph/star
	...
	icon_state = "star"
	new_armor = list(BURN = 70, BRAIN = 70, BRUTE = 60, TOX = 40) // 240
...
/obj/item/clothing/suit/armor/ego_gear/aleph/da_capo
	...
	icon_state = "da_capo"
	new_armor = list(BURN = 60, BRAIN = 100, BRUTE = 60, TOX = 20) // 240
...
/obj/item/clothing/suit/armor/ego_gear/aleph/mimicry
	...
	icon_state = "mimicry"
	new_armor = list(BURN = 80, BRAIN = 50, BRUTE = 50, TOX = 60) // 240
...
/obj/item/clothing/suit/armor/ego_gear/aleph/twilight
	...
	icon_state = "twilight"
	new_armor = list(BURN = 80, BRAIN = 60, BRUTE = 80, TOX = 80) // 300
...
/obj/item/clothing/suit/armor/ego_gear/aleph/adoration
	...
	new_armor = list(BURN = 70, BRAIN = 50, BRUTE = 70, TOX = 50) // 240
...
/obj/item/clothing/suit/armor/ego_gear/aleph/smile
	...
	new_armor = list(BURN = 50, BRAIN = 50, BRUTE = 80, TOX = 60) // 240
...
/obj/item/clothing/suit/armor/ego_gear/aleph/blooming
	...
	icon_state = "blooming"
	flags_inv = HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT
	new_armor = list(BURN = 80, BRAIN = 80, BRUTE = 0, TOX = 80) // 240
...
/obj/item/clothing/suit/armor/ego_gear/aleph/flowering
	...
	icon_state = "air"
	flags_inv = HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT
	new_armor = list(BURN = 80, BRAIN = 80, BRUTE = 30, TOX = 90) // 280
...
/obj/item/clothing/suit/armor/ego_gear/aleph/praetorian
	...
	new_armor = list(BURN = 80, BRAIN = 60, BRUTE = 60, TOX = 40)	//armor was made before the abnormality.
...
/obj/item/clothing/suit/armor/ego_gear/aleph/censored
	...
	icon_state = "censored"
	new_armor = list(BURN = 60, BRAIN = 40, BRUTE = 80, TOX = 60)
...
/obj/item/clothing/suit/armor/ego_gear/aleph/soulmate
	...
	icon_state = "soulmate"
	new_armor = list(BURN = 80, BRAIN = 50, BRUTE = 40, TOX = 70)
...
/obj/item/clothing/suit/armor/ego_gear/aleph/space
	...
	icon_state = "space"
	new_armor = list(BURN = 30, BRAIN = 80, BRUTE = 80, TOX = 50)
...
/obj/item/clothing/suit/armor/ego_gear/aleph/nihil
	...
	icon_state = "nihil"
	new_armor = list(BURN = 60, BRAIN = 70, BRUTE = 70, TOX = 40) // 240 - 300, 15 per upgrade; caps out at 70,80,80,70
...
/obj/item/clothing/suit/armor/ego_gear/aleph/seasons
	...
	icon_state = "spring"
	new_armor = list(BURN = 60, BRAIN = 60, BRUTE = 60, TOX = 60, FIRE = 60) // Placeholder values, changed later.
...
/obj/item/clothing/suit/armor/ego_gear/aleph/distortion
	...
	new_armor = list(BURN = 80, BRAIN = 70, BRUTE = 80, TOX = 50, FIRE = 70) // 280
...
/obj/item/clothing/suit/armor/ego_gear/aleph/willing
	...
	icon_state = "willing"
	new_armor = list(BURN = 80, BRAIN = 60, BRUTE = 60, TOX = 40) // 240
...
/obj/item/clothing/suit/armor/ego_gear/aleph/pink
	...
	icon_state = "pink"
	new_armor = list(BURN = 50, BRAIN = 70, BRUTE = 70, TOX = 50) // 240
...
/obj/item/clothing/suit/armor/ego_gear/aleph/arcadia
	...
	icon_state = "arcadia"
	new_armor = list(BURN = 70, BRAIN = 50, BRUTE = 60, TOX = 60) // 240
...
/obj/item/clothing/suit/armor/ego_gear/aleph/giant
	...
	icon_state = "giant"
	new_armor = list(BURN = 80, BRAIN = 30, BRUTE = 80, TOX = 50) // 240
...
/obj/item/clothing/suit/armor/ego_gear/aleph/throne
	...
	icon_state = "throne"
	new_armor = list(BURN = 60, BRAIN = 60, BRUTE = 60, TOX = 60) // 240 - Maybe do something special with this one in the future.
