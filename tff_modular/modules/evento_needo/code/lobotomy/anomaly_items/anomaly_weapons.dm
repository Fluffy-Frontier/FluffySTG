...
/obj/item/gun/energy/vortex_gun
	...
	icon = 'tff_modular/modules/evento_needo/icons/Teguicons/bhole_projector.dmi'
...
/obj/projectile/beam/vortex_bullet/on_hit(atom/target, blocked = FALSE, pierce_hit)
	if(ishuman(target))
		var/mob/living/carbon/human/dead_man = target
		dead_man.Sleeping(6 SECONDS)
	return ..()

/obj/projectile/beam/vortex_bullet/Moved(atom/old_loc, movement_dir, forced, list/old_locs, momentum_change)
	. = ..()
