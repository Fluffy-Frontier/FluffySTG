...
/obj/item/attachment
	...
	desc = "alert coders"
	icon = 'tff_modular/modules/evento_needo/icons/attachments.dmi'
	...
	var/toggled = FALSE
	var/toggle_on_sound = 'sound/items/weapons/magin.ogg'
	var/toggle_off_sound = 'sound/items/weapons/magout.ogg'
	...
	//var/render_layer = ABOVE_OBJ_LAYER //inhands
	//var/render_plane = ABOVE_HUD_PLANE //world
...
/obj/item/attachment/proc/apply_attachment(obj/item/gun/gun, mob/user)
	...
	gun_cell = gun.cell
	playsound(src.loc, 'tff_modular/modules/evento_needo/sounds/pistol/mag_insert_alt.ogg', 75, 1)
	return TRUE
...
/obj/item/attachment/proc/remove_attachment(obj/item/gun/gun, mob/user)
	...
	playsound(src.loc, 'tff_modular/modules/evento_needo/sounds/pistol/mag_release_alt.ogg', 75, 1)
	gun_cell = null
	return TRUE
