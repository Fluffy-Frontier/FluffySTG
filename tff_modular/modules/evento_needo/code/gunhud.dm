...
// Ammo counter
#define ui_ammocounter_shiptest "EAST-1:28,CENTER+1:25"

/datum/hud
	var/atom/movable/screen/ammo_counter_shiptest_shiptest

/atom/movable/screen/ammo_counter_shiptest
	name = "ammo counter"
	icon = 'tff_modular/modules/evento_needo/icons/gun_hud.dmi'
	icon_state = "backing"
...
/atom/movable/screen/ammo_counter_shiptest/proc/turn_off()
	invisibility = INVISIBILITY_ABSTRACT
	maptext = null
...
/atom/movable/screen/ammo_counter_shiptest/proc/turn_on()
	invisibility = 0
...
/atom/movable/screen/ammo_counter_shiptest/proc/set_hud(_backing_color, _oth_o, _oth_t, _oth_h, _indicator)
...
/atom/movable/screen/ammo_counter_shiptest/update_overlays(list/rounds)
	. = ..()
	cut_overlays()
	if(oth_o)
...
/datum/component/ammo_hud_shiptest
	var/atom/movable/screen/ammo_counter_shiptest/hud
	/// The prefix used for the hud
	var/prefix = ""
	var/indicator = ""
	var/backing_color = "#FFFFFF" // why was this hardcoded dlfhakhjdfj

/datum/component/ammo_hud_shiptest/Initialize()
	. = ..()
	if(!istype(parent, /obj/item/gun) && !istype(parent, /obj/item/weldingtool))
		return COMPONENT_INCOMPATIBLE
	RegisterSignal(parent, COMSIG_ITEM_EQUIPPED, PROC_REF(wake_up))

/datum/component/ammo_hud_shiptest/Destroy()
	turn_off()
	return ..()

/datum/component/ammo_hud_shiptest/proc/wake_up(datum/source, mob/user, slot)
	SIGNAL_HANDLER
...
/datum/component/ammo_hud_shiptest/proc/turn_on()
	SIGNAL_HANDLER
...
/datum/component/ammo_hud_shiptest/proc/turn_off()
	SIGNAL_HANDLER
...
/datum/component/ammo_hud_shiptest/proc/get_accurate_ammo_count(obj/item/gun/ballistic/the_gun)
...
/datum/component/ammo_hud_shiptest/proc/get_accurate_laser_count(obj/item/gun/energy/the_gun)
	var/obj/item/ammo_casing/energy/current_mode = the_gun.chambered
	if(!current_mode)
		return FALSE
	return round(the_gun.cell.charge/current_mode.e_cost)

/datum/component/ammo_hud_shiptest/proc/update_hud()
	SIGNAL_HANDLER
...
/datum/component/ammo_hud_shiptest/laser/update_hud()
...
/datum/component/ammo_hud_shiptest/laser/cybersun
	prefix = "cybersun_"
...
/datum/component/ammo_hud_shiptest/revolver
	prefix = "revolver_"

/// Returns get_ammo() with the appropriate args passed to it - some guns like the revolver and bow are special cases
/datum/component/ammo_hud_shiptest/revolver/get_accurate_ammo_count(obj/item/gun/ballistic/revolver/the_gun)
	if(istype(the_gun, /obj/item/gun/ballistic/revolver))
		var/obj/item/gun/ballistic/revolver/the_revolver = the_gun
...
/datum/component/ammo_hud_shiptest/revolver/update_hud()
	...
	for(var/obj/item/ammo_casing/bullet as anything in rounds)
		...
		if(!bullet)
			continue
		var/image/current_bullet_image = image(icon = 'tff_modular/modules/evento_needo/icons/gun_hud.dmi')
		...
		current_bullet_image.icon_state = "revolver_casing[bullet.loaded_projectile ? "_live" : ""]"
		round_images += current_bullet_image

	hud.update_overlays(round_images)

/datum/component/ammo_hud_shiptest/eoehoma
	backing_color = "#cb001a"

/datum/component/ammo_hud_shiptest/eoehoma/update_hud()
...
/datum/component/ammo_hud_shiptest/counter
