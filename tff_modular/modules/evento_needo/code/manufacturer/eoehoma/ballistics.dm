/obj/item/gun/ballistic/automatic/assault/e40
	...
	fire_sound = 'tff_modular/modules/evento_needo/sounds/laser/e40_bal.ogg'
...
/obj/item/gun/ballistic/automatic/assault/e40/Initialize()
	. = ..()
	AddComponent(/datum/component/ammo_hud_shiptest/eoehoma) // at long last... the ammo counter on the side of the sprite is functional...
...
/obj/item/gun/ballistic/automatic/assault/e40/attackby(obj/item/attack_obj, mob/user, params)
	if(istype(attack_obj, /obj/item/stock_parts/power_store/cell))
...
/obj/item/gun/ballistic/automatic/assault/e40/click_alt(mob/user)
	. = ..()
	var/current_firemode = gun_firemodes[firemode_index]
	if(current_firemode == FIREMODE_OTHER)
