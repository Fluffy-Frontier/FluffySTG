/obj/item/gun/ballistic/automatic/fg42
	...
	fire_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/fire/fg42_fire.ogg'

	rack_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/batrifle_cock.ogg'
	load_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/batrifle_magin.ogg'
	load_empty_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/batrifle_magin.ogg'
	eject_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/batrifle_magout.ogg'
	eject_empty_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/batrifle_magout.ogg'
