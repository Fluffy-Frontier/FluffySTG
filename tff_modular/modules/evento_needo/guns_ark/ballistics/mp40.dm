/obj/item/gun/ballistic/automatic/mp40 // Dont Use in GunCargo
	...
	burst_size = 1
	fire_delay = 1.7
	fire_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/fire/mp40_fire.ogg'
	fire_sound_volume = 100
	rack_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/smg_cock.ogg'
	load_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/smg_magin.ogg'
	load_empty_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/smg_magin.ogg'
	eject_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/smg_magout.ogg'
