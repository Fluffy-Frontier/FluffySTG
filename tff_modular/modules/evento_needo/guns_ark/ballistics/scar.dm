/obj/item/gun/ballistic/automatic/scar
	...
	can_suppress = FALSE
	fire_delay = 2.4
	fire_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/fire/scar_fire.ogg'
	fire_sound_volume = 50
	rack_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/scar_cock.ogg'
	load_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/scar_mag_out.ogg'
	load_empty_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/scar_mag_in.ogg'
	eject_sound = 'tff_modular/modules/evento_needo/guns_ark/sound/guns/interact/scar_mag_out.ogg'
	burst_size = 1
